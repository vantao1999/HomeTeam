  ...
  return (
    <View style={styles.container}>
      <View style = {styles.header}>
        <Text type="regular20" color={Colors.white} marginLeft={20} marginVertical={40}>Đặt Hàng</Text>
      </View>
      <View style ={styles.content}>
        <View style = {styles.viewProduct}>
          ...
          {props.data.image ? (
            <FastImage source = {{uri: props.data.image}} resizeMode={FastImage.resizeMode.cover} style = {styles.productImg}/>
          ):(
            <FastImage source={Images.dummy} resizeMode={FastImage.resizeMode.cover} style={styles.productImg}></FastImage>
          )}
        </View>
        ...
        <Text type="regular12" color={Colors.blur}>Hình thức thanh toán (Thanh toán khi nhận hàng)</Text>
        <Button label="ĐẶT HÀNG" color={Colors.primary} style = {styles.Btn} onPress={formik.handleSubmit}></Button>
      </View>
    </View>
  );
};
